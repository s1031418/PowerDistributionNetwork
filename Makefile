...
run_case1:
	time ./$(OUTPUT_NAME) TestCase/2017/case1/case1.v TestCase/2017/case1/case1_input.def TestCase/2017/case1/tech.lef TestCase/2017/case1/blocks.lef TestCase/2017/case1/initial_files case1_output.def case1.sp output_files
run_case2:
...
run_case5:	
	time ./$(OUTPUT_NAME) TestCase/2017/case5/case5.v TestCase/2017/case5/case5_input.def TestCase/2017/case5/tech.lef TestCase/2017/case5/blocks.lef TestCase/2017/case5/initial_files case5_output.def case5.sp output_files
run_case6:	
...
run_case7:	
	time ./$(OUTPUT_NAME) TestCase/test/test2/test2.v TestCase/test/test2/test2_input.def TestCase/test/test2/tech.lef TestCase/test/test2/blocks.lef TestCase/test/test2/initial_files test2_output.def test2.sp output_files
run_case8:	
	time ./$(OUTPUT_NAME) TestCase/test/test3/test3.v TestCase/test/test3/test3_input.def TestCase/test/test3/tech.lef TestCase/test/test3/blocks.lef TestCase/test/test3/initial_files test3_output.def test3.sp output_files
run_case9:	
	time ./$(OUTPUT_NAME) TestCase/test/test4/test4.v TestCase/test/test4/test4_input.def TestCase/test/test4/tech.lef TestCase/test/test4/blocks.lef TestCase/test/test4/initial_files test4_output.def test4.sp output_files
run_case10:	
	time ./$(OUTPUT_NAME) TestCase/test/test5/test5.v TestCase/test/test5/test5_input.def TestCase/test/test5/tech.lef TestCase/test/test5/blocks.lef TestCase/test/test5/initial_files test5_output.def test5.sp output_files
run_case11:	
	time ./$(OUTPUT_NAME) TestCase/test/test6/test6.v TestCase/test/test6/test6_input.def TestCase/test/test6/tech.lef TestCase/test/test6/blocks.lef TestCase/test/test6/initial_files test6_output.def test6.sp output_files
run_case12:	
	time ./$(OUTPUT_NAME) TestCase/test/test7/test7.v TestCase/test/test7/test7_input.def TestCase/test/test7/tech.lef TestCase/test/test7/blocks.lef TestCase/test/test7/initial_files test7_output.def test7.sp output_files
run_case13:	
	time ./$(OUTPUT_NAME) TestCase/test/test8/test8.v TestCase/test/test8/test8_input.def TestCase/test/test8/tech.lef TestCase/test/test8/block.lef TestCase/test/test8/initial_files test8_output.def test8.sp output_files
run_case14:	
	time ./$(OUTPUT_NAME) TestCase/test/test9/test9.v TestCase/test/test9/test9_input.def TestCase/test/test9/tech.lef TestCase/test/test9/blocks.lef TestCase/test/test9/initial_files test9_output.def test9.sp output_files
run_case15:	
	time ./$(OUTPUT_NAME) TestCase/test/test10/test10.v TestCase/test/test10/test10_input.def TestCase/test/test10/tech.lef TestCase/test/test10/blocks.lef TestCase/test/test10/initial_files test10_output.def test10.sp output_files
run_case16:	
