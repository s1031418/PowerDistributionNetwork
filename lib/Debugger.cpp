...
void Debugger::printComponentMsg(string BlockName ,  std::map<std::string,Components> & ComponentMaps)
{
...
void Debugger::printAllComponentMsg(std::map<std::string,Components> & ComponentMaps)
{
    for(auto i : ComponentMaps)
        printComponentMsg(i.first, ComponentMaps);
}
void Debugger::printPinMsg(string PinName ,  std::map<std::string,Pin> & PinMaps)
{
...
void Debugger::printAllPinMsg(std::map<std::string,Pin> & PinMaps)
{
    for(auto x : PinMaps)
    {
...
void Debugger::printPortMsg(string MetalName ,std::multimap< std::string, Port > & PortMaps)
{
...
void Debugger::printAllPortMsg(std::multimap< std::string, Port > & PortMaps)
{
...
void Debugger::printSpecialNetMsg(string SourceName , std::map<std::string,SpecialNets> & SpecialNetsMaps)
{
...
void Debugger::printDestinationMsg(string BlockName , std::multimap<std::string,std::string> & DESTINATIONMAPS)
{
...
void Debugger::printAllDestinationMsg(std::multimap<std::string,std::string> & DESTINATIONMAPS)
{
...
void Debugger::printNetsMsg(string MetalName ,std::multimap<std::string,Nets> & NETSMULTIMAPS )
{
...
void Debugger::printAllNetsMsg(std::multimap<std::string,Nets> & NETSMULTIMAPS )
{
...
void Debugger::printAllSpecialNetMsg(std::map<std::string,SpecialNets> & SpecialNetsMaps)
{
...
void Debugger::printDieArea(Diearea & diearea)
{
