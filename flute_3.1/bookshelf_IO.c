...
void readAuxFile(char benchmarkPath[], char auxFile[]) 
{
    ...
    strcat(temp, "/");
    strcat(temp, auxFile);
    nodesFile = reinterpret_cast<char *>(cvector(0, BUFFERSIZE));
    netsFile = reinterpret_cast<char *>(cvector(0, BUFFERSIZE));
    wtsFile = reinterpret_cast<char *>(cvector(0, BUFFERSIZE));
    sclFile = reinterpret_cast<char *>(cvector(0, BUFFERSIZE));
    plFile = reinterpret_cast<char *>(cvector(0, BUFFERSIZE));
    benchmarkName = reinterpret_cast<char *>(cvector(0, BUFFERSIZE));
